        ...
        products.length > 0 ? (
          <div className='container mx-auto h-auto grid grid-cols-5 gap-8'>
            <div className='w-full bg-white px-4 col-span-5 xl:col-span-4'>
              <div className='font-titleFont hidden xl:flex items-center justify-between border-b-[1px]
          border-b-gray-400 py-3'>
              ...
              <div>
                ...
                p-4 md:py-4 flex items-center gap-6'>
              ...
              <div className='bg-[#F0F2F2] flex justify-center items-center gap-2 w-50 py-4 text-center drop-shadow-lg rounded-md'>
                <button onClick={() => dispatch(resetCart())} className='bg-green-500 px-10 py-2 hover:bg-green-900 active:bg-green-500 text-white rounded-lg font-titleFont font-semibold text-lg tracking-wide'>Clear all items</button>
              </div>
            </div>
            <div className="col-span-5 md:col-span-3 lg:col-span-2 xl:col-span-1 bg-white h-52 flex flex-col items-center p-4">
              <div >
          ...
          <motion.div ref={ref}
            ...
            transition={{ duration: 0.5, delay: 0.5 }} className='flex justify-center gap-4 py-10'>
            <div >
